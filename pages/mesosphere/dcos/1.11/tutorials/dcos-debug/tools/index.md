...
**Note:** Need a scalable way to manage and search your logs? It could be worth building an [ELK stack for log aggregation and filtering](/mesosphere/dcos/1.11/monitoring/logging/aggregating/filter-elk/).
