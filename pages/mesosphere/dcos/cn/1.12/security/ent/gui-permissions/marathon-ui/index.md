...
### 任务详情和日志
 要查看任务详情和日志，您必须授予访问 [Mesos UI](/mesosphere/dcos/cn/1.12/security/ent/gui-permissions/mesos-ui/) 的权限。
...
### 任务详情和日志
 要查看 Marathon 任务详情和日志，您必须授予访问 [Mesos UI](/mesosphere/dcos/cn/1.12/security/ent/gui-permissions/mesos-ui/) 的权限。
